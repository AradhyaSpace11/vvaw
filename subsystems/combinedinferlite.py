...
from project_paths import DEMOVIDEO_DIR, YOLO_DIR, YOLO_WEIGHTS
...
def main():
    ...
    vid_num = input("Enter demovid number (e.g., 1 for demovid1.mp4): ").strip()
    if not vid_num:
        print("No number entered. Exiting.")
        return
        
    vid_name = f"demovid{vid_num}.mp4"
    ...
    precomputed_data.clear() # Flush as requested
